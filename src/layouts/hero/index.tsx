...
function Hero() {
    return (
        ...
        >
            ...
            <div className="lg:max-w-sm w-2/3">
                <Image src={plumber} alt="A cartoonish illustration of a plumber fixing a broken pipe, with water spilling out, using tools like a wrench." className="object-cover object-center" />
            </div>
        </section>
    )
}
